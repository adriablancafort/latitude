...
<Note>
  GDPR is a regulatory framework, not a point-in-time certification like ISO 27001 or a SOC 2 audit report. Latitude's GDPR work covers documentation, operational practices, data handling, and customer-facing process readiness.
</Note>
